...
public struct SunAngle: Equatable, Hashable, Codable, Sendable {
        
  public static let zero: SunAngle = .init()
    ...
    public static func degrees(_ value: Double) -> SunAngle {
        .init(degrees: value)
    }
    
    public static func radians(_ value: Double) -> SunAngle {
        .init(radians: value)
    }
