...
public struct HorizonCoordinates: Equatable, Hashable, Codable, Sendable {
    ...
    public func horizon2Equatorial(latitude: SunAngle) -> EquatorialCoordinates{
        ...
        let declination: SunAngle = .init(radians:asin(tZeroHorizonToEquatorial))
        ...
        var hourAngle: SunAngle = .init(radians: acos(tTwoHorizonToEquatorial))
