...
public struct EclipticCoordinates: Equatable, Hashable, Codable, Sendable {
    ...
    public static let obliquityOfTheEcliptic: SunAngle = .init(degrees: 23.439292)
    
    public var eclipticLatitude: SunAngle //beta
    public var eclipticLongitude: SunAngle //lambda
    ...
    public func ecliptic2Equatorial() -> EquatorialCoordinates{
        ...
        //Step4:
        let tEclipticToEquatorial: SunAngle = .init(radians: sin(eclipticLatitude.radians) * cos(EclipticCoordinates.obliquityOfTheEcliptic.radians) + cos(eclipticLatitude.radians) * sin(EclipticCoordinates.obliquityOfTheEcliptic.radians) * sin(eclipticLongitude.radians))
        
        //Step5:
        let moonDeclination: SunAngle = .init(radians: asin(tEclipticToEquatorial.radians))
        ...
        //Step8:
        var r: SunAngle = .init(radians: atan(yEclipticToEquatorial / xEclipticToEquatorial))
        ...
        let alfa: SunAngle  = .init(degrees: r.degrees / 15)
        let delta: SunAngle = .init(degrees: moonDeclination.degrees)
